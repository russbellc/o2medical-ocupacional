	...
	(mod.escaner.munici = {
		...
		init: function (r) {
			...
			this.win = new Ext.Window({
				...
				resizable: true,
				html:
					"<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_escane&sys_report=municipalidad&" +
					params +
					"'></iframe>",
			});
			this.win.show();
...
mod.escaner.nuevo = {
	...
	crea_controles: function () {
		this.win = new Ext.Window({
			...
			resizable: true,
			html:
				"<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_auditoria&sys_report=reporte&adm=" +
				this.record.get("adm") +
				"'></iframe>",
		});
	},
...
mod.escaner.reporte = {
	...
	init: function (r) {
		...
		this.win = new Ext.Window({
			...
			resizable: true,
			html:
				"<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_auditoria&sys_report=reporte&" +
				params +
				"'></iframe>",
		});
		this.win.show();

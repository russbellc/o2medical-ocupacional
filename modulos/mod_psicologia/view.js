        ...
        this.dt_grid = new Ext.grid.GridPanel({
            ...
            listeners: {
                rowclick: function (grid, rowIndex, e) {
                    ...
                    } else if (record.get('ex_id') == 59) {//examen ALTURA
...
//                    mod.psicologia.examenPRE.init(record);//
                ...
                rowcontextmenu: function (grid, index, event) {
                    ...
                    if (record.get('st') == "1") {
                                        ...
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    ...
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_psicologia&sys_report=formato_psico_informe&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
                                        ...
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    ...
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_psicologia&sys_report=formato_psico_examen&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
                                                Ext.MessageBox.alert('Observaciones', 'El paciente no fue registrado correctamente');
                                            }
                        ...
                        } else if (record.get('ex_id') == 59) {   //PSICOLOGIA - LAS BAMBAS
                            new Ext.menu.Menu({
                                items: [{
                                        text: 'EXAMEN PSICOLOGICO N°: <B>' + record.get('adm') + '<B>',
                                        iconCls: 'reporte',
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    ...
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_psicologia&sys_report=formato_altura180&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
                                                Ext.MessageBox.alert('Observaciones', 'El paciente no fue registrado correctamente');
                                            }
...
//m_psico_inf_capac_intelectual
        this.m_psico_inf_capac_intelectual = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'MEDIO', name: 'm_psico_inf_capac_intelectual', inputValue: 'MEDIO'},
...
//m_psico_inf_aten_concentracion
        this.m_psico_inf_aten_concentracion = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'MEDIO', name: 'm_psico_inf_aten_concentracion', inputValue: 'MEDIO'},
...
//m_psico_inf_orient_espacial
        this.m_psico_inf_orient_espacial = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'MEDIO', name: 'm_psico_inf_orient_espacial', inputValue: 'MEDIO'},
...
//m_psico_inf_htp
        this.m_psico_inf_htp = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'INESTABLE', name: 'm_psico_inf_htp', inputValue: 'INESTABLE'}
            ]
        });
//m_psico_inf_raven
        this.m_psico_inf_raven = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'PROMEDIO', name: 'm_psico_inf_raven', inputValue: 'PROMEDIO'},
...
//m_psico_inf_laberinto
        this.m_psico_inf_laberinto = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'MEDIO', name: 'm_psico_inf_laberinto', inputValue: 'MEDIO'},
...
//m_psico_inf_bc4
        this.m_psico_inf_bc4 = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'CONDUCTA SEGURA', name: 'm_psico_inf_bc4', inputValue: 'CONDUCTA SEGURA'},
                {boxLabel: 'CONDUCTA INSEGURA', name: 'm_psico_inf_bc4', inputValue: 'CONDUCTA INSEGURA'}
            ]
        });
//m_psico_inf_precision
        this.m_psico_inf_precision = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'MEDIO', name: 'm_psico_inf_precision', inputValue: 'MEDIO'},
...
//m_psico_inf_destreza
        this.m_psico_inf_destreza = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'MEDIO', name: 'm_psico_inf_destreza', inputValue: 'MEDIO'},
...
//m_psico_inf_reaccion
        this.m_psico_inf_reaccion = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'MEDIO', name: 'm_psico_inf_reaccion', inputValue: 'MEDIO'},
...
//m_psico_exam_accid_enfermedad
        this.m_psico_exam_accid_enfermedad = new Ext.form.TextArea({
            ...
            fieldLabel: '<b>ACIDENTES Y ENFERMEDADES(DURANTE EL TIEMPO DEL TRABAJO)</b>',
            anchor: '99%',
            value: 'NINGUNA',
            height: 70
        });
//m_psico_exam_habitos
        this.m_psico_exam_habitos = new Ext.form.TextArea({
            ...
            fieldLabel: '<b>HABITOS (PASATIEMPOS, CONSUMO DE TABACO, ALCOHOL DROGAS)</b>',
            anchor: '99%',
...
//m_psico_exam_presentacion
        this.m_psico_exam_presentacion = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_presentacion', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_presentacion', inputValue: 'INADECUADO'}
            ]
        });
//m_psico_exam_postura
        this.m_psico_exam_postura = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ERGUIDA', name: 'm_psico_exam_postura', inputValue: 'ERGUIDA', checked: true},
                {boxLabel: 'ENCORVADA', name: 'm_psico_exam_postura', inputValue: 'ENCORVADA'}
            ]
        });
//m_psico_exam_ritmo
        this.m_psico_exam_ritmo = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'RÁPIDO', name: 'm_psico_exam_ritmo', inputValue: 'RÁPIDO'},
                {boxLabel: 'FLUIDO', name: 'm_psico_exam_ritmo', inputValue: 'FLUIDO', checked: true}
            ]
        });
//m_psico_exam_tono
        this.m_psico_exam_tono = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'MODERADO', name: 'm_psico_exam_tono', inputValue: 'MODERADO', checked: true},
...
//m_psico_exam_articulacion
        this.m_psico_exam_articulacion = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'CON DIFICULTAD', name: 'm_psico_exam_articulacion', inputValue: 'CON DIFICULTAD'},
                {boxLabel: 'SIN DIFICULTAD', name: 'm_psico_exam_articulacion', inputValue: 'SIN DIFICULTAD', checked: true}
            ]
        });
//m_psico_exam_tiempo
        this.m_psico_exam_tiempo = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ORIENTADO', name: 'm_psico_exam_tiempo', inputValue: 'ORIENTADO', checked: true},
                {boxLabel: 'DESORIENTADO', name: 'm_psico_exam_tiempo', inputValue: 'DESORIENTADO'}
            ]
        });
//m_psico_exam_espacio
        this.m_psico_exam_espacio = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ORIENTADO', name: 'm_psico_exam_espacio', inputValue: 'ORIENTADO', checked: true},
                {boxLabel: 'DESORIENTADO', name: 'm_psico_exam_espacio', inputValue: 'DESORIENTADO'}
            ]
        });
//m_psico_exam_persona
        this.m_psico_exam_persona = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ORIENTADO', name: 'm_psico_exam_persona', inputValue: 'ORIENTADO', checked: true},
                {boxLabel: 'DESORIENTADO', name: 'm_psico_exam_persona', inputValue: 'DESORIENTADO'}
            ]
        });
//m_psico_exam_lucido_atent
        this.m_psico_exam_lucido_atent = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_lucido_atent', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_lucido_atent', inputValue: 'INADECUADO'}
            ]
        });
//m_psico_exam_pensamiento
        this.m_psico_exam_pensamiento = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_pensamiento', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_pensamiento', inputValue: 'INADECUADO'}
            ]
        });
//m_psico_exam_persepcion
        this.m_psico_exam_persepcion = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_persepcion', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_persepcion', inputValue: 'INADECUADO'}
            ]
        });
//m_psico_exam_memoria
        this.m_psico_exam_memoria = new Ext.form.RadioGroup({
            ...
            columns: 3,
            items: [
                {boxLabel: 'CORTO PLAZO', name: 'm_psico_exam_memoria', inputValue: 'CORTO PLAZO', checked: true},
                {boxLabel: 'MEDIANO PLAZO', name: 'm_psico_exam_memoria', inputValue: 'MEDIANO PLAZO'},
                {boxLabel: 'LARGO PLAZO', name: 'm_psico_exam_memoria', inputValue: 'LARGO PLAZO'}
            ]
        });
...
//m_psico_exam_apetito
        this.m_psico_exam_apetito = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_apetito', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_apetito', inputValue: 'INADECUADO'}
            ]
        });
//m_psico_exam_sueño
        this.m_psico_exam_sueno = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_sueno', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_sueno', inputValue: 'INADECUADO'}
            ]
        });
//m_psico_exam_personalidad
        this.m_psico_exam_personalidad = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_personalidad', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_personalidad', inputValue: 'INADECUADO'}
            ]
        });
//m_psico_exam_afectividad
        this.m_psico_exam_afectividad = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_afectividad', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_afectividad', inputValue: 'INADECUADO'}
            ]
        });
//m_psico_exam_conduc_sexual
        this.m_psico_exam_conduc_sexual = new Ext.form.RadioGroup({
            ...
            columns: 2,
            items: [
                {boxLabel: 'ADECUADO', name: 'm_psico_exam_conduc_sexual', inputValue: 'ADECUADO', checked: true},
                {boxLabel: 'INADECUADO', name: 'm_psico_exam_conduc_sexual', inputValue: 'INADECUADO'}
            ]
        });
...
//m_psico_exam_ptje_test_14
        ...
        this.frm = new Ext.FormPanel({
            ...
            items: [{
                    title: '<b>--->  DATOS OCUPACIONALES - HISTORIA FAMILIAR - ANTECEDENTES Y ENFERMEDADES - HABITOS - EXAMEN MENTAL - DIAGNOSTICO FINAL</b>',
                    iconCls: 'demo2',
                    layout: 'column',
                    autoScroll: true,
                    border: false,
...
//                                            labelAlign: 'top',
                                            ...
                                            labelWidth: 180,
//                                            labelAlign: 'top',
                                            items: [this.m_psico_exam_activ_empresa, this.m_psico_exam_princ_riesgos, this.m_psico_exam_medi_seguridad]
                                        }]
                                }]
                        }, {
                            columnWidth: .50,
                    ...
                    title: '<b>--->  PUNTAJE DE CUSTIONARIOS - INVENTARIO - ESCALA - TEST - CLIMA LABORAL - WAIS - LURIA</b>',
                    iconCls: 'demo2',
                    layout: 'column',
                    autoScroll: true,
                    border: false,
...
//                            labelAlign: 'top',
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.psicologia.examen_psicologia.win.el.mask('Guardando…', 'x-mask-loading');
                        this.frm.getForm().submit({params: {
                                acction: (this.record.get('st') >= 1) ? 'update_psico_examen' : 'save_psico_examen'
                                , id: this.record.get('id')
                                , adm: this.record.get('adm')
                                , ex_id: this.record.get('ex_id')
                            },
...
//                mod.psicologia.psicologia_altura.val_medico.setRawValue(r.medico_nom);
    ...
    crea_stores: function () {
        ...
        this.list_conclu_altu_psico = new Ext.data.JsonStore({
            ...
            root: 'data',
            totalProperty: 'total',
            fields: ['conclu_altu_psico_id', 'conclu_altu_psico_adm', 'conclu_altu_psico_desc'],
            listeners: {
                'beforeload': function (store, options) {
                    this.baseParams.adm = mod.psicologia.psicologia_altura.record.get('adm');
                }
            }
        });
    },
...
//m_psico_altura_entrena_altura
        this.m_psico_altura_entrena_altura = new Ext.form.ComboBox({
            ...
            fieldLabel: '<b>RECIBIÓ ENTRENAMIENTO PARA TRABAJOS EN ALTURAS MAYORES A 1.8M</b>',
            allowBlank: false,
            typeAhead: false, editable: false,
            mode: 'local',
            forceSelection: true,
...
//m_psico_altura_equilibrio_03
        this.m_psico_altura_equilibrio_03 = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["NORMAL", 'NORMAL'], ["NO REALIZADO", 'NO REALIZADO'], ["-", '-']]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_psico_altura_aptitud
        this.m_psico_altura_aptitud = new Ext.form.RadioGroup({
            ...
            columns: 1,
            items: [
                {boxLabel: 'APTO', name: 'm_psico_altura_aptitud', inputValue: 'APTO'},
                {boxLabel: 'APTO CON RESTRICCIONES', name: 'm_psico_altura_aptitud', inputValue: 'APTO CON RESTRICCIONES'},
                {boxLabel: 'NO APTO', name: 'm_psico_altura_aptitud', inputValue: 'NO APTO'},
                {boxLabel: 'EN PROCESO DE VALIDACION', name: 'm_psico_altura_aptitud', inputValue: 'EN PROCESO DE VALIDACION', checked: true}
            ]
        });
        ...
        this.frm = new Ext.FormPanel({
            ...
            items: [{
                    title: '<b>--->  EXAMEN OCUPACIONAL PARA TRABAJOS EN ALTURA MAYOR A  1.80 m</b>',
                    iconCls: 'demo2',
                    layout: 'column',
                    autoScroll: true,
                    border: false,
                        ...
                        , {
                            ...
                            items: [{
                                    ...
                                    items: [{
                                        ...
                                        , {
                                            xtype: 'compositefield',
                                            fieldLabel: '<b>¿SE MOLESTA SI LLEGA TARDE A ALGÚN COMPROMISO?<b>',
                                            bodyStyle: 'padding:3px;',
                                            items: [
                                        ...
                                        , {
                                            xtype: 'compositefield',
                                            fieldLabel: '<b>¿LE HA MOLESTADO ALGUNA VEZ LA GENTE CRITICÁNDOLE SU FORMA DE BEBER?<b>',
                                            bodyStyle: 'padding:3px;',
                                            items: [
                                        ...
                                        , {
                                            xtype: 'compositefield',
                                            fieldLabel: '<b>¿HA SENTIDO QUE ESTAR EN UNA REUNIÓN DIVIRTIÉNDOSE LO REANIMA?<b>',
                                            bodyStyle: 'padding:3px;',
                                            items: [
                                        ...
                                        , {
                                            xtype: 'compositefield',
                                            fieldLabel: '<b>¿HA TENIDO ALGUNA VEZ LA IMPRESIÓN DE QUE DEBERÍA BEBER MENOS?<b>',
                                            bodyStyle: 'padding:3px;',
                                            items: [
                                        ...
                                        , {
                                            xtype: 'compositefield',
                                            fieldLabel: '<b>¿SE HA SENTIDO ALGUNA VEZ MAL O CULPABLE POR SU COSTUMBRE DE BEBER?<b>',
                                            bodyStyle: 'padding:3px;',
                                            items: [
                                        ...
                                        , {
                                            xtype: 'compositefield',
                                            fieldLabel: '<b>¿ALGUNA VEZ LO PRIMERO QUE HA HECHO POR LA MAÑANA HA SIDO BEBER PARA CALMAR?<b>',
                                            bodyStyle: 'padding:3px;',
                                            items: [
                                        ...
                                        , {
                                            xtype: 'compositefield',
                                            fieldLabel: '<b>¿SUFRE DE DOLORES EN LA ESPALDA AL LEVANTARSE?<b>',
                                            bodyStyle: 'padding:3px;',
                                            items: [
                                            ...
                                            items: [{
                                                    ...
                                                    items: [
                                                        ...
                                                        , {
                                                            ...
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_01
                                                            ]
                                                        }
                                                        , {
                                                            xtype: 'compositefield',
                                                            ...
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_02
                                                            ]
                                                        }
                                                        , {
                                                            xtype: 'compositefield',
                                                            fieldLabel: '<b>SUSTENTACIÓN EN UN PIE POR 15 SEGUNDOS<b>',
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_03
                                                            ]
                                                        }
                                                        , {
                                                            xtype: 'compositefield',
                                                            fieldLabel: '<b>CAMINAR LIBRE SOBRE UNA RECTA 3M SIN DESVÍO<b>',
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_04
                                                            ]
                                                        }
                                                        , {
                                                            xtype: 'compositefield',
                                                            fieldLabel: '<b>CAMINAR LIBRE CON LOS OJOS VENDADOS 3M SIN DESVÍO<b>',
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_05
                                                            ]
                                                        }
                                                        , {
                                                            xtype: 'compositefield',
                                                            fieldLabel: '<b>CAMINAR LIBRE CON LOS OJOS VENDADOS EN PUNTA TALÓN 3 M SIN DESVÍO<b>',
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_06
                                                            ]
                                                        }
                                                        , {
                                                            xtype: 'compositefield',
                                                            fieldLabel: '<b>ROTAR SOBRE UNA SILLA Y LUEGO VERIFICAR EQUILIBRIO DE PIE<b>',
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_07
                                                            ]
                                                        }
                                                        , {
                                                            xtype: 'compositefield',
                                                            ...
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_08
                                                            ]
                                                        }
                                                        , {
                                                            xtype: 'compositefield',
                                                            ...
                                                            bodyStyle: 'padding:3px;',
                                                            items: [
                                                                this.m_psico_altura_equilibrio_09
                                                            ]
                                                        }
                                                    ]
                                                }]
...
//                                            labelAlign: 'top',
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.psicologia.psicologia_altura.win.el.mask('Guardando…', 'x-mask-loading');
                        this.frm.getForm().submit({params: {
                                acction: (this.record.get('st') >= 1) ? 'update_psicologia_altura' : 'save_psicologia_altura'
                                , id: this.record.get('id')
                                , adm: this.record.get('adm')
                                , ex_id: this.record.get('ex_id')
                            },
    ...
    crea_controles: function () {
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.psicologia.altura_conclu.win.el.mask('Guardando…', 'x-mask-loading');
                        var metodo;
                        var conclu_altu_psico_id;
                        if (this.record2 !== null) {
                            metodo = 'update';
                            conclu_altu_psico_id = mod.psicologia.altura_conclu.record2.get('conclu_altu_psico_id');
                        } else {
                            metodo = 'save';
                        ...
                        this.frm.getForm().submit({params: {
                                ...
                                , conclu_altu_psico_adm: mod.psicologia.psicologia_altura.record.get('adm')

...
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $triaje->data[0]->m_tri_triaje_peso, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'HEMOGLOBINA', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $lab_hemograma->data[0]->m_lab_hemo_hemoglobina, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(35, $h, 'GLUCOSA', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $glucosa->data[0]->m_lab_exam_resultado, 1, 1, 'C', 0); //////VALUE


$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'ESTATURA', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $triaje->data[0]->m_tri_triaje_talla, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'HEMATOCRITO', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $lab_hemograma->data[0]->m_lab_hemo_hematocrito, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(35, $h, 'HbA1C', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, '', 1, 1, 'C', 0); //////VALUE


$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'IMC', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $triaje->data[0]->m_tri_triaje_imc, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'TRIGLICERIDOS', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $lipido->data[0]->m_lab_p_lipido_trigliceridos, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(35, $h, 'GRUPO Y FACTOR', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $grupo_fac->data[0]->m_lab_exam_resultado, 1, 1, 'C', 0); //////VALUE


$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'PRESION ARTERIAL', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $triaje->data[0]->m_tri_triaje_pa_sistolica . '/' . $triaje->data[0]->m_tri_triaje_pa_diastolica, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'COL. TOTAL', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $lipido->data[0]->m_lab_p_lipido_colesterol_total, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(35, $h, 'RIESGO CORONARIO', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $lipido->data[0]->m_lab_p_lipido_riesg_coronario, 1, 1, 'C', 0); //////VALUE


$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'PULSO (¿regular?)', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $triaje->data[0]->m_tri_triaje_fc, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'HDL COLESTEROL', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $lipido->data[0]->m_lab_p_lipido_colesterol_hdl, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
...
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $triaje->data[0]->m_tri_triaje_fr, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'LDL COLESTEROL', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $lipido->data[0]->m_lab_p_lipido_colesterol_ldl, 1, 0, 'C', 0); //////VALUE
$pdf->Cell(5, $h, '', 0, 0, 'C', 0);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(35, $h, 'SUB UNIDAD B HGC SERICA', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $hcg->data[0]->m_lab_exam_resultado, 1, 1, 'C', 0); //////VALUE


$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'SAT O2', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(25, $h, $triaje->data[0]->m_tri_triaje_saturacion, 1, 1, 'C', 0); //////VALUE
...
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(150, $h, $ekg_conclu->data[0]->conclu_concat, 1, 1, 'L', 0); //////VALUE

$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(30, $h, 'PRUEBA DE ESFUERZO', 1, 0, 'C', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->Cell(150, $h, '', 1, 1, 'L', 0); //////VALUE

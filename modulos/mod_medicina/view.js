                                    ...
                                    handler: function () {
                                        if (record.get('st') >= 1) {
                                            new Ext.Window({
                                                ...
                                                closeAction: 'close',
                                                resizable: true,
                                                html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_medicina&sys_report=formato_resumen&adm=" + record.get('adm') + "'></iframe>"
                                            }).show();
                                        } else {
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    handler: function () {
                        ...
                        var params = "fini=" + mod.medicina.rfecha.f_inicio.getRawValue() + "&ffinal=" + mod.medicina.rfecha.f_final.getRawValue() + "&empresa=" + mod.medicina.rfecha.cboEmpre.getValue();
                        new Ext.Window({
                            title: 'Referencia',
                            width: 200,
                            height: 200,
                            ...
                            closeAction: 'close',
                            resizable: true,
                            html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadexcel&sys_modname=mod_senso&sys_report=reporte&" + params + "'></iframe>"
                    ...
                    handler: function () {
                        ...
                        new Ext.Window({
                            ...
                            closeAction: 'close',
                            resizable: true,
                            html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_senso&sys_report=reportefecha&" + params + "'></iframe>"
        ...
        this.dt_grid = new Ext.grid.GridPanel({
            ...
            listeners: {
                rowdblclick: function (grid, rowIndex, e) {
                    e.stopEvent();
                    var record = grid.getStore().getAt(rowIndex);//
                    if (record.get('ex_id') == 20) {//NUEVO EXAMEN DE MEDICINA ANEXO 16
                        mod.medicina.nuevoAnexo16.init(record);
                    } else if (record.get('ex_id') == 39) {//ANTECEDENTES OCUPACIONALES NUEVO ANEXO 16
                        mod.medicina.antecedentes16.init(record);
                    } else if (record.get('ex_id') == 40) {//ANTECEDENTES OCUPACIONALES ANEXO 16
                        mod.medicina.antece16_viejo.init(record);
                    } else if (record.get('ex_id') == 41) {//EXAMEN OSTEO MUSCULAR
                        mod.medicina.nuevoOsteo.init(record);
                    } else if (record.get('ex_id') == 42) {//EXAMEN ANEXO 16A - PERFIL VISITA
                        mod.medicina.anexo_16a.init(record);
                    } else if (record.get('ex_id') == 60) {//EXAMEN MENEJO
                ...
                rowcontextmenu: function (grid, index, event) {
                    ...
                    if (record.get('st') == "1") {
                        if (record.get('ex_id') == 20) {
                            new Ext.menu.Menu({
                                items: [{
                                        text: 'Nuevo Anexo 16 Informe N°: <B>' + record.get('adm') + '<B>',
                                        iconCls: 'reporte',
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    title: 'Nuevo Anexo 16 Informe N° ' + record.get('adm'),
                                                    width: 800,
                                                    height: 600,
                                                    maximizable: true,
                                                    modal: true,
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_medicina&sys_report=inf_nuevo_anexo_16&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
                                                Ext.MessageBox.alert('Observaciones', 'El paciente no fue registrado correctamente');
                                            }
                            ...
                            new Ext.menu.Menu({
                                items: [{
                                        text: 'Antecedentes Laborales N°: <B>' + record.get('adm') + '<B>',
                                        iconCls: 'reporte',
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    title: 'Antecedentes Laborales N° ' + record.get('adm'),
                                                    width: 800,
                                                    height: 600,
                                                    maximizable: true,
                                                    modal: true,
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_medicina&sys_report=antecede_16&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
                                                Ext.MessageBox.alert('Observaciones', 'El paciente no fue registrado correctamente');
                                            }
                                        ...
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    ...
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_medicina&sys_report=formato_antecede&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
                                                Ext.MessageBox.alert('Observaciones', 'El paciente no fue registrado correctamente');
                                            }
                        ...
                        } else if (record.get('ex_id') == 41) {   //formato_osteo_muscular
                            new Ext.menu.Menu({
                                items: [{
                                        text: 'EXAMEN OSTEO MUSCULAR N°: <B>' + record.get('adm') + '<B>',
                                        iconCls: 'reporte',
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    title: 'EXAMEN OSTEO MUSCULAR N° ' + record.get('adm'),
                                                    width: 800,
                                                    height: 600,
                                                    maximizable: true,
                                                    modal: true,
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_medicina&sys_report=formato_osteo_musc&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
                                                Ext.MessageBox.alert('Observaciones', 'El paciente no fue registrado correctamente');
                                            }
                        ...
                        } else if (record.get('ex_id') == 42) {   //anexo 16A formato_osteo_musc
                            new Ext.menu.Menu({
                                items: [{
                        ...
                        } else if (record.get('ex_id') == 60) {   //anexo 16A formato_osteo_musc
                            new Ext.menu.Menu({
                                items: [{
                                        text: 'FORMATO PARA MANEJO N°: <B>' + record.get('adm') + '<B>',
                                        iconCls: 'reporte',
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    ...
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_medicina&sys_report=formato_manejo&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
                                                Ext.MessageBox.alert('Observaciones', 'El paciente no fue registrado correctamente');
                                            }
...
//m_med_tip_opera
        this.m_med_tip_opera = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [
                    ['SUPERFICIE', 'SUPERFICIE'], ["CONCENTRADORA", 'CONCENTRADORA'],
                    ["SUBSUELO", 'SUBSUELO'], ["-", '-']]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_altura_lab
        this.m_med_altura_lab = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [
                    ['HASTA 3000 m', 'HASTA 3000 m'], ["3001 A 3500 m", '3001 A 3500 m'],
                    ["3501 A 4000 m", '3501 A 4000 m'], ["4001 A 4500 m", '4001 A 4500 m'], ["MAS DE 4501 m", 'MAS DE 4501 m']]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_rl_bio1
        this.m_med_rl_bio1 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_med_rl_bio1', inputValue: 'NO', checked: true}
            ]
        });
//m_med_rl_ergo1
        this.m_med_rl_ergo = new Ext.form.CheckboxGroup({
            ...
            items: [
                ...
                {boxLabel: 'MOVIMIENTOS REPETITIVOS', name: 'm_med_rl_ergo3', inputValue: 'MOVIMIENTOS REPETITIVOS'},
...
//m_med_rl_fisico1
        this.m_med_rl_fisico = new Ext.form.CheckboxGroup({
            ...
            items: [
                ...
                {boxLabel: 'PRECIONES', name: 'm_med_rl_fisico2', inputValue: 'PRECIONES'},
                {boxLabel: 'TEMPERATURA', name: 'm_med_rl_fisico3', inputValue: 'TEMPERATURA'},
                {boxLabel: 'ILUMINACION', name: 'm_med_rl_fisico4', inputValue: 'ILUMINACION'},
                {boxLabel: 'VIBRACION TOTAL', name: 'm_med_rl_fisico5', inputValue: 'VIBRACION TOTAL'},
                {boxLabel: 'VIBRACION SEGMENTARIA', name: 'm_med_rl_fisico6', inputValue: 'VIBRACION SEGMENTARIA'},
                {boxLabel: 'RADIACION IONIZANTE Y NO IONIZANTE', name: 'm_med_rl_fisico7', inputValue: 'RADIACION IONIZANTE Y NO IONIZANTE'},
                {boxLabel: 'TEMPERATURAS EXTREMAS', name: 'm_med_rl_fisico8', inputValue: 'TEMPERATURAS EXTREMAS'},
                {boxLabel: 'RADIACION INFRAROJA Y ULTRAVIOLETA', name: 'm_med_rl_fisico9', inputValue: 'RADIACION INFRAROJA Y ULTRAVIOLETA'},
...
//m_med_rl_psico1
        this.m_med_rl_psico = new Ext.form.CheckboxGroup({
            ...
            items: [
                ...
                {boxLabel: 'FATIGA LABORAL', name: 'm_med_rl_psico2', inputValue: 'FATIGA LABORAL'},
                {boxLabel: 'MONOTONIA', name: 'm_med_rl_psico3', inputValue: 'MONOTONIA'},
...
//m_med_rl_quimi1
        this.m_med_rl_quimi = new Ext.form.CheckboxGroup({
            ...
            columns: 7,
            items: [
                {boxLabel: 'GASES Y VAPORES', name: 'm_med_rl_quimi1', inputValue: 'GASES Y VAPORES'},
                {boxLabel: 'POLVOS', name: 'm_med_rl_quimi2', inputValue: 'POLVOS'},
                {boxLabel: 'LIQUIDOS', name: 'm_med_rl_quimi3', inputValue: 'LIQUIDOS'},
                {boxLabel: 'DISOLVENTES', name: 'm_med_rl_quimi4', inputValue: 'DISOLVENTES'},
                {boxLabel: 'SOLVENTES', name: 'm_med_rl_quimi5', inputValue: 'SOLVENTES'},
                {boxLabel: 'METALES PESADOS', name: 'm_med_rl_quimi6', inputValue: 'METALES PESADOS'},
...
//m_med_muj_resul
        this.m_med_muj_resul = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["1", "NORMAL"], ["2", "ANORMAL"], ["3", "NUNCA SE HIZO"]]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_muj_mac
        this.m_med_muj_mac = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_muj_mac', inputValue: 'No', checked: true}
            ]
        });
//m_med_muj_obs
...
//m_med_muj_a
        this.m_med_muj_a = new Ext.form.TextField({
            fieldLabel: '<b>a</b> nº total embarzos, incluye abortos, molas hidatiformes y embarazos ectopicos',
            name: 'm_med_muj_a',
            disabled: ((this.record.get('pac_sexo') == 'F') ? false : true),
            anchor: '95%'
        });
...
//m_med_cardio_op01
        this.m_med_cardio_op01 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op01', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_op02
        this.m_med_cardio_op02 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿HA TENIDO ALGUN TIPO DE ATAQUE, CONVULSION, PERDIDA DE CONOCIMIENTO O EPILEPSIA?</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op02', inputValue: 'Si',
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op02', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc02
...
//m_med_cardio_op03
        this.m_med_cardio_op03 = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op03', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op03', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc03
...
//m_med_cardio_op04
        this.m_med_cardio_op04 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿HA SUFRIDO ALGUN TIPO DE TRASTORNO MENTAL / PSIQUIATRICO?</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op04', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op04', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc04
...
//m_med_cardio_op05
        this.m_med_cardio_op05 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿HA SUFRIDO DE ALGUN TRASTORNO DE SUEÑO?. ¿HA REQUERIDO PASTILLAS PARA DORMIR?</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op05', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op05', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc05
...
//m_med_cardio_op06
        this.m_med_cardio_op06 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿HA SUFRIDO DE BRONQUITIS, OTROS PROBLEMAS RESPITORIOS EN LOS ULTIMOS 06 MESES?</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op06', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op06', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc06
...
//m_med_cardio_op07
        this.m_med_cardio_op07 = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op07', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op07', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc07
...
//m_med_cardio_op08
        this.m_med_cardio_op08 = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op08', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op08', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc08
...
//m_med_cardio_op09
        this.m_med_cardio_op09 = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op09', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op09', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc09
...
//m_med_cardio_op10
        this.m_med_cardio_op10 = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op10', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op10', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc10
...
//m_med_cardio_op11
        this.m_med_cardio_op11 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿ALGUNA HISTORIA DE ANEMIA?, ¿SE ENCUENTRA EMBARAZADA?</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op11', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op11', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc11
...
//m_med_cardio_op12
        this.m_med_cardio_op12 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿ALGUNA HISTORIA DE ENFERMEDAD DE COAGULACION O TROMBOSIS?</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op12', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op12', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc12
...
//m_med_cardio_op13
        this.m_med_cardio_op13 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿UD. SUFRE DE DOLOR DE PECHO O FALTA DE AIRE AL ESFUERZO?</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op13', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op13', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc13
...
//m_med_cardio_op14
        this.m_med_cardio_op14 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿UD. SUFRE DE PROBLEMAS CARDIACOS, ANGINA, USA MARCAPASOS?</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op14', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op14', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc14
...
//m_med_cardio_op15
        this.m_med_cardio_op15 = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op15', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op15', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc15
...
//m_med_cardio_op16
        this.m_med_cardio_op16 = new Ext.form.RadioGroup({
            fieldLabel: '<b>¿SE LE HA DIAGNOSTICADO OBESIDAD MORBIDA (IMC>35 Kg/m2)</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op16', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op16', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc16
...
//m_med_cardio_op17
        this.m_med_cardio_op17 = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op17', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op17', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc17
...
//m_med_cardio_op18
        this.m_med_cardio_op18 = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Si', name: 'm_med_cardio_op18', inputValue: 'Si',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                ...
                {boxLabel: 'No', name: 'm_med_cardio_op18', inputValue: 'No', checked: true}
            ]
        });
//m_med_cardio_desc18
...
//m_med_tabaco
        this.m_med_tabaco = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["NADA", 'NADA'], ['POCO', 'POCO'], ["HABITUAL", 'HABITUAL'], ["EXCESIVO", 'EXCESIVO']]
            }),
...
//m_med_fam_hijos
        this.m_med_fam_hijos = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_fam_hijos', inputValue: 'No', checked: true}
            ]
        });
//m_med_fam_h_vivos
...
//m_med_fam_infarto55
        this.m_med_fam_infarto55 = new Ext.form.RadioGroup({
            fieldLabel: '<b>SU PADRE O HERMANO HA TENIDO UN CUADRO DE INFARTO DE MIOCARDIO (ATAQUE AL CORAZON) ANTES DE LOS 55 AÑOS.</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_fam_infarto55', inputValue: 'Si'},
                {boxLabel: 'No', name: 'm_med_fam_infarto55', inputValue: 'No', checked: true}
            ]
        });
//m_med_fam_infarto65
        this.m_med_fam_infarto65 = new Ext.form.RadioGroup({
            fieldLabel: '<b>SU MADRE O HERMANA HA TENIDO UN CUADRO DE INFARTO DE MIOCARDIO (ATAQUE AL CORAZON) ANTES DE LOS 65 AÑOS.</b>',
            items: [
                {boxLabel: 'Si', name: 'm_med_fam_infarto65', inputValue: 'Si'},
                {boxLabel: 'No', name: 'm_med_fam_infarto65', inputValue: 'No', checked: true}
            ]
        });
//m_med_piel_desc
...
//m_med_oido_der01
        this.m_med_oido_der01 = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["CAE PERMEABLE", "CAE PERMEABLE"], ["CAE NO PERMEABLE", "CAE NO PERMEABLE"]]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_oido_der02
        this.m_med_oido_der02 = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["NO RETRACCION", "NO RETRACCION"], ["CON RETRACCION", "CON RETRACCION"]]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_oido_der03
        this.m_med_oido_der03 = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["NO PERFORACIONES", "NO PERFORACIONES"], ["CON PERFORACIONES", "CON PERFORACIONES"]]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_oido_der04
        this.m_med_oido_der04 = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["TRIANGULO DE LUZ PRESENTE", "TRIANGULO DE LUZ PRESENTE"], ["TRIANGULO DE LUZ NO PRESENTE", "TRIANGULO DE LUZ NO PRESENTE"]]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_pru_sup_der
        this.m_med_pru_sup_der = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_pru_sup_der', inputValue: 'No', checked: true}
            ]
        });
//m_med_pru_med_der
        this.m_med_pru_med_der = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_pru_med_der', inputValue: 'No', checked: true}
            ]
        });
//m_med_pru_inf_der
        this.m_med_pru_inf_der = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_pru_inf_der', inputValue: 'No', checked: true}
            ]
        });
//m_med_ppl_der
        this.m_med_ppl_der = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_ppl_der', inputValue: 'No', checked: true}
            ]
        });
//m_med_pru_sup_izq
        this.m_med_pru_sup_izq = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_pru_sup_izq', inputValue: 'No', checked: true}
            ]
        });
//m_med_pru_med_izq
        this.m_med_pru_med_izq = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_pru_med_izq', inputValue: 'No', checked: true}
            ]
        });
//m_med_pru_inf_izq
        this.m_med_pru_inf_izq = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_pru_inf_izq', inputValue: 'No', checked: true}
            ]
        });
//m_med_ppl_izq
        this.m_med_ppl_izq = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'No', name: 'm_med_ppl_izq', inputValue: 'No', checked: true}
            ]
        });
//m_med_tacto
        this.m_med_tacto = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'NO SE HIZO', name: 'm_med_tacto', inputValue: 'NO SE HIZO', checked: true},
...
//m_med_anillos
        this.m_med_anillos = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_med_anillos', inputValue: 'NO', checked: true}
            ]
        });
//m_med_anillos_desc
...
//m_med_hernia
        this.m_med_hernia = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_med_hernia', inputValue: 'NO', checked: true}
            ]
        });
//m_med_hernia_desc
...
//m_med_varices
        this.m_med_varices = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_med_varices', inputValue: 'NO', checked: true}
            ]
        });
//m_med_varices_desc
...
//m_med_aptitud
        this.m_med_aptitud = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'APTO CON OBSERVACIONES', name: 'm_med_aptitud', inputValue: 'APTO CON OBSERVACIONES'},
                {boxLabel: 'APTO CON RESTRICCIÓN', name: 'm_med_aptitud', inputValue: 'APTO CON RESTRICCIÓN'},
                {boxLabel: 'NO APTO TEMPORAL', name: 'm_med_aptitud', inputValue: 'NO APTO TEMPORAL'},
                {boxLabel: 'NO APTO DEFINITIVO', name: 'm_med_aptitud', inputValue: 'NO APTO DEFINITIVO'},
                //{boxLabel: 'RETIRO', name: 'm_med_aptitud', inputValue: 'RETIRO'},
                //{boxLabel: 'OBSERVADO', name: 'm_med_aptitud', inputValue: 'OBSERVADO'},
                {boxLabel: 'EN PROCESO DE VALIDACION', name: 'm_med_aptitud', inputValue: 'EN PROCESO DE VALIDACION', checked: true}
            ]
        });
//m_med_fech_val
...
//OTROS DIAGNOSTICOS
        this.tbar1 = new Ext.Toolbar({
            items: ['<b style="color:#000000;">OTROS DIAGNOSTICOS</b>',
                '-', '->', {
                    text: 'Nuevo',
                    iconCls: 'nuevo',
                    handler: function () {
...
//OBSERVACIONES
        this.tbar2 = new Ext.Toolbar({
            items: ['<b style="color:#000000;">OBSERVACIONES</b>',
                '-', '->', {
                    text: 'Nuevo',
                    iconCls: 'nuevo',
                    handler: function () {
...
//RESTRICCIONES
        this.tbar3 = new Ext.Toolbar({
            items: ['<b style="color:#000000;">RESTRICCIONES</b>',
                '-', '->', {
                    text: 'Nuevo',
                    iconCls: 'nuevo',
                    handler: function () {
...
//INTERCONSULTAS
        this.tbar4 = new Ext.Toolbar({
            items: ['<b style="color:#000000;">INTERCONSULTAS</b>',
                '-', '->', {
                    text: 'Nuevo',
                    iconCls: 'nuevo',
                    handler: function () {
...
//RECOMENDACIONES E INDICACIONES
        this.tbar5 = new Ext.Toolbar({
            items: ['<b style="color:#000000;">RECOMENDACIONES E INDICACIONES</b>',
                '-', '->', {
                    text: 'Nuevo',
                    iconCls: 'nuevo',
                    handler: function () {
...
//FRM ANEXO 16
        this.frm = new Ext.FormPanel({
            ...
            items: [{
                    title: '<b>--->  ESTADO OCUPACIONAL - RIESGOS OCUPACIONALES - EXAMEN MUJERES - ANTECEDENTES LABORALES - HABITOS - ANTECEDENTES FAMILIARES</b>',
                    iconCls: 'demo2',
                    layout: 'column',
                    autoScroll: true,
                    border: false,
...

                        {
                            ...
                            items: [{
                                    ...
                                    items: [{
                                            ...
                                            columnWidth: .80, border: false,
                                            bodyStyle: 'padding:10px 0px 0px 0px;',
                                            labelAlign: 'top', layout: 'form',
                                            items: [this.m_med_rl_psico]
                                        }, {
                                            columnWidth: .999, border: false,
...
//                                    title: '',
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.nuevoAnexo16.win.el.mask('Guardando…', 'x-mask-loading');
                        this.frm.getForm().submit({params: {
                                acction: (this.record.get('st') >= 1) ? 'update_nuevoAnexo16' : 'save_nuevoAnexo16'
...
mod.medicina.diagnostico = {
    ...
    crea_controles: function () {
        ...
        this.diag_tipo = new Ext.form.RadioGroup({
            ...
            columns: 1,
            items: [
                {boxLabel: 'TEXTUAL', name: 'diag_tipo', inputValue: '1', checked: true,
                ...
                {boxLabel: 'CIE 10', name: 'diag_tipo', inputValue: '2',
                    handler: function (values, checkbox) {
                        if (checkbox == true) {
...
//            disabled: true,
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.diagnostico.win.el.mask('Guardando…', 'x-mask-loading');
                        var metodo;
                        var diag_id;
                        if (this.record2 !== null) {
                            metodo = 'update';
...
mod.medicina.observacion = {
    ...
    crea_controles: function () {
        ...
        this.obs_plazo = new Ext.form.RadioGroup({
            ...
            columns: 4,
            items: [
                {boxLabel: 'NINGUNO(-)', name: 'obs_plazo', inputValue: '-', checked: true},
...
//            disabled: true,
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.observacion.win.el.mask('Guardando…', 'x-mask-loading');
                        var metodo;
                        var obs_id;
                        if (this.rec !== null) {
                            metodo = 'update';
...
mod.medicina.restricciones = {
    ...
    crea_controles: function () {
        ...
        this.restric_plazo = new Ext.form.RadioGroup({
            ...
            columns: 4,
            items: [
                {boxLabel: 'NINGUNO', name: 'restric_plazo', inputValue: '-', checked: true},
                {boxLabel: 'INMEDIATO', name: 'restric_plazo', inputValue: 'INMEDIATO'},
...
//            disabled: true,
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.restricciones.win.el.mask('Guardando…', 'x-mask-loading');
                        var metodo;
                        var restric_id;
                        if (this.rec !== null) {
                            metodo = 'update';
...
mod.medicina.interconsultas = {
    ...
    crea_controles: function () {
        ...
        this.inter_plazo = new Ext.form.RadioGroup({
            ...
            columns: 4,
            items: [
                {boxLabel: 'NINGUNO(-)', name: 'inter_plazo', inputValue: '-', checked: true},
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.interconsultas.win.el.mask('Guardando…', 'x-mask-loading');
                        var metodo;
                        var inter_id;
                        if (this.rec !== null) {
                            metodo = 'update';
...
mod.medicina.recomendaciones = {
    ...
    crea_controles: function () {
        ...
        this.recom_plazo = new Ext.form.RadioGroup({
            ...
            columns: 4,
            items: [
                {boxLabel: 'NINGUNO(-)', name: 'recom_plazo', inputValue: '-', checked: true},
...
//            disabled: true,
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.recomendaciones.win.el.mask('Guardando…', 'x-mask-loading');
                        var metodo;
                        var recom_id;
                        if (this.rec !== null) {
                            metodo = 'update';
...
mod.medicina.antecedentes16 = {
    ...
    crea_stores: function () {
        this.st = new Ext.data.JsonStore({
            ...
            root: 'data',
            totalProperty: 'total',
            fields: ['m_antec_16_id', 'm_antec_16_adm', 'm_antec_16_exa', 'm_antec_16_ini_fech', 'm_antec_16_fin_fech', 'm_antec_16_ocupacion', 'm_antec_16_empresa', 'm_antec_16_actividad', 'm_antec_16_area_trab', 'm_antec_16_altitud', 'm_antec_16_tipo_ope', 'm_antec_16_time_trab']
        });
    },
    crea_controles: function () {
        this.paginador = new Ext.PagingToolbar({
        ...
        this.tbar = new Ext.Toolbar({
            items: ['-', {
                    ...
                    handler: function () {
                        new Ext.Window({
                            title: 'Antecedentes Laborales N° ' + mod.medicina.antecedentes16.record.get('adm'),
                            width: 800,
                            height: 600,
                            maximizable: true,
                            modal: true,
                            closeAction: 'close',
                            resizable: true,
                            html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_medicina&sys_report=antecede_16&adm=" + mod.medicina.antecedentes16.record.get('adm') + "'></iframe>"
                        }).show();
                    }
                }
            ]
...
mod.medicina.nuevo_antecedentes16 = {
    ...
    crea_controles: function () {
        ...
        this.m_antec_16_tipo_ope = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [['SUPERFICIE', 'SUPERFICIE'], ['SUBTERRANEO', 'SUBTERRANEO']]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
        ...
        this.antec_16_riesgos = new Ext.form.CheckboxGroup({
            ...
            columns: 7,
            items: [
                {boxLabel: '<b>FISICO</b>', name: 'm_antec_16_fisico_agen', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>QUIMICO</b>', name: 'm_antec_16_quimico_agen', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>ELECTRICO</b>', name: 'm_antec_16_electrico_agen', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>ERGONOMICO</b>', name: 'm_antec_16_ergo_agen', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>BIOLOGICO</b>', name: 'm_antec_16_biologico_agen', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>PSICOSOCIAL</b>', name: 'm_antec_16_psico_agen', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>OTROS</b>', name: 'm_antec_16_otros_agen', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
...
//                            title: '<b>RIESGOS OCUPACIONALES</b>',
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.nuevo_antecedentes16.win.el.mask('Guardando…', 'x-mask-loading');
                        this.frm.getForm().submit({
                            params: {
                                acction: (this.rec !== null) ? 'update_nuevo_antecedentes16' : 'save_nuevo_antecedentes16'
...
mod.medicina.antece16_viejo = {
    ...
    crea_stores: function () {
        this.st = new Ext.data.JsonStore({
            ...
            root: 'data',
            totalProperty: 'total',
            fields: ['m_antec_id', 'm_antec_adm', 'm_antec_fech_ini', 'm_antec_fech_fin', 'm_antec_cargo', 'm_antec_empresa', 'm_antec_proyec', 'm_antec_alti']
        });
    },
    crea_controles: function () {
        this.paginador = new Ext.PagingToolbar({
        ...
        this.tbar = new Ext.Toolbar({
            items: ['-', {
                    ...
                    handler: function () {
                        new Ext.Window({
                            title: 'Antecedentes Laborales N° ' + mod.medicina.antece16_viejo.record.get('adm'),
                            width: 800,
                            height: 600,
                            maximizable: true,
                            modal: true,
                            closeAction: 'close',
                            resizable: true,
                            html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_medicina&sys_report=formato_antecede&adm=" + mod.medicina.antece16_viejo.record.get('adm') + "'></iframe>"
                        }).show();
                    }
                }
            ]
...
mod.medicina.nuevo_antece16_viejo = {
    ...
    crea_controles: function () {
        ...
        this.antec_16_riesgos = new Ext.form.CheckboxGroup({
            ...
            columns: 5,
            items: [
                {boxLabel: '<b>FISICO</b>', name: 'm_antec_fisico', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>QUIMICO</b>', name: 'm_antec_quinico', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>BIOLOGICO</b>', name: 'm_antec_biologico', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>ERGONOMICO</b>', name: 'm_antec_ergonom', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
                    ...
                    }}, {boxLabel: '<b>OTROS</b>', name: 'm_antec_otros', inputValue: '1',
                    handler: function (value, checkbox) {
                        if (checkbox == true) {
...
//                            title: '<b>RIESGOS OCUPACIONALES</b>',
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.nuevo_antece16_viejo.win.el.mask('Guardando…', 'x-mask-loading');
                        this.frm.getForm().submit({
                            params: {
                                acction: (this.rec !== null) ? 'update_nuevo_antece16_viejo' : 'save_nuevo_antece16_viejo'
...
//m_osteo_sup_acor_fu_sen_coment
        this.m_osteo_sup_acor_fu_sen_coment = new Ext.form.TextField({
            fieldLabel: '<b>ACORTAMIENTOS/FLACIDECES, FUERZA MUSCULAR, SENSIBILIDAD</b>',
...
//m_osteo_test_jobe_der
        this.m_osteo_test_jobe_der = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["NEGATIVO", 'NEGATIVO'], ["POSITIVO", 'POSITIVO']]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_osteo_aptitud
        this.m_osteo_aptitud = new Ext.form.RadioGroup({
            ...
            columns: 1,
            items: [
                {boxLabel: 'APTO', name: 'm_osteo_aptitud', inputValue: 'APTO', checked: true},
                {boxLabel: 'APTO CON OBSERVACION', name: 'm_osteo_aptitud', inputValue: 'APTO CON OBSERVACION'},
...
//        });
        ...
        this.tbar4 = new Ext.Toolbar({
            items: ['<b style="color:#000000;">CONCLUSIONES Y RECOMENDACIONES</b>',
                '-', '->', {
                    text: 'Nuevo',
                    iconCls: 'nuevo',
                    handler: function () {
        ...
        this.frm = new Ext.FormPanel({
            ...
            items: [{
                    ...
                    items: [{
                            ...
                            items: [{
                                    ...
                                    items: [{
                                            ...
                                            items: [{
                                                    xtype: 'fieldset', layout: 'column',
                                                    title: 'DESVIACION DEL EJE ANTERO - POSTERIOR  (EVALUACIÓN EN BIPEDESTACIÓN)',
                                                    items: [{
                                                            columnWidth: .33,
                                                            border: false,
                                                            layout: 'form',
                            ...
                            items: [{
                                    xtype: 'fieldset', layout: 'column',
                                    title: 'EXAMEN FISICO -- CUELLO Y TRONCO (EVALUAR LOS RANGOS  DE  MOVILIDAD ACTIVA Y PASIVA)',
                                    items: [{
                                            xtype: 'panel', border: false,
                                            columnWidth: .999,
                                            bodyStyle: 'padding:2px 22px 0px 5px;',
                    ...
                    title: '<b>--->  EXTREMIDADES SUPERIORES - EXTREMIDADES INFERIORES</b>',
                    iconCls: 'demo2',
                    layout: 'column',
                    autoScroll: true,
                    border: false,
                    ...
                    title: '<b>--->  EXTREMIDADES SUPERIORES E INFERIORES - TEST - MANIOBRAS - REFLEJO - CONCLUSION - APTITUD</b>',
                    iconCls: 'demo2',
                    layout: 'column',
                    autoScroll: true,
                    border: false,
                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [{
                                                    xtype: 'fieldset', layout: 'column',
                                                    title: 'TEST DE JOBE ( ELEVAR BRAZOS CONTRA RESISTENCIA- PULGAR ABAJO)',
                                                    items: [{
                                                            columnWidth: .12,
                                                            border: false,
                                                            layout: 'form',
...
//                                            labelAlign: 'top',
            ...
            buttons: [{
                    ...
                    handler: function () {
                        ...
                        this.frm.getForm().submit({params: {
                                acction: (this.record.get('st') >= 1) ? 'update_nuevoOsteo' : 'save_nuevoOsteo'
                                , id: this.record.get('id')
                                , adm: this.record.get('adm')
                                , ex_id: this.record.get('ex_id')
                            },
    ...
    crea_controles: function () {
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.osteo_conclusion.win.el.mask('Guardando…', 'x-mask-loading');
                        var metodo;
                        var osteo_conclu_id;
                        if (this.rec !== null) {
                            metodo = 'update';
                            osteo_conclu_id = mod.medicina.osteo_conclusion.rec.get('osteo_conclu_id');
                        } else {
                            metodo = 'save';
...
//anexo_16a_aptitud
        this.anexo_16a_aptitud = new Ext.form.RadioGroup({
            ...
            columns: 1,
            items: [
                {boxLabel: 'APTO', name: 'anexo_16a_aptitud', inputValue: 'APTO', checked: true},
//                {boxLabel: 'APTO CON RESTRICCIONES', name: 'anexo_16a_aptitud', inputValue: 'APTO CON RESTRICCIONES'},
                {boxLabel: 'NO APTO', name: 'anexo_16a_aptitud', inputValue: 'NO APTO'}
            ]
        });
...
//anexo_16a_vacuna
        this.anexo_16a_vacuna = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'anexo_16a_vacuna', inputValue: 'NO', checked: true}
            ]
        });
//grid de observaciones
        ...
        this.frm = new Ext.FormPanel({
            ...
            items: [{
                    title: '<b>--->  ANTECEDENTES MÉDICOS PERSONALES- OBSERVACIONES - APTITUD</b>',
                    iconCls: 'demo2',
                    layout: 'column',
                    autoScroll: true,
                    border: false,
            ...
            buttons: [{
                    ...
                    handler: function () {
                        ...
                        this.frm.getForm().submit({params: {
                                acction: (this.record.get('st') >= 1) ? 'update_anexo_16a' : 'save_anexo_16a'
                                , id: this.record.get('id')
                                , adm: this.record.get('adm')
                                , ex_id: this.record.get('ex_id')
                            },
...
mod.medicina.obs_16a = {
    ...
    crea_controles: function () {
        ...
        this.obs_16a_plazo = new Ext.form.RadioGroup({
            ...
            columns: 4,
            items: [
                {boxLabel: 'NINGUNO(-)', name: 'obs_16a_plazo', inputValue: '-', checked: true},
                {boxLabel: 'INMEDIATO', name: 'obs_16a_plazo', inputValue: 'INMEDIATO'},
...
//                mod.medicina.medicina_manejo.val_medico.setRawValue(r.medico_nom);
    ...
    crea_stores: function () {
        ...
        this.list_manejo_conclu = new Ext.data.JsonStore({
            ...
            root: 'data',
            totalProperty: 'total',
            fields: ['conclu_conduc_med_id', 'conclu_conduc_med_adm', 'conclu_conduc_med_desc'],
            listeners: {
                'beforeload': function (store, options) {
...
//m_med_manejo_mariposa
        this.m_med_manejo_mariposa = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["APTO", 'APTO'], ["NO APTO", 'NO APTO'], ["-", '-']]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_manejo_weschler
        this.m_med_manejo_weschler = new Ext.form.ComboBox({
            store: new Ext.data.ArrayStore({
                fields: ['campo', 'descripcion'],
                data: [["APTO", 'APTO'], ["NO APTO", 'NO APTO'], ["NO CORRESPONDE", 'NO CORRESPONDE'], ["-", '-']]
            }),
            displayField: 'descripcion',
            valueField: 'campo',
...
//m_med_manejo_test_monotimia
        ...
        this.m_med_manejo_tipo_equipo = new Ext.form.RadioGroup({
            ...
            columns: 1,
            items: [
                {boxLabel: 'EQUIPO LIVIANO', name: 'm_med_manejo_tipo_equipo', inputValue: 'EQUIPO LIVIANO', checked: true},
                {boxLabel: 'EQUIPO PESADO', name: 'm_med_manejo_tipo_equipo', inputValue: 'EQUIPO PESADO'}
            ]
        });
//m_med_manejo_aptitud
        this.m_med_manejo_aptitud = new Ext.form.RadioGroup({
            ...
            columns: 1,
            items: [
                {boxLabel: 'APTO', name: 'm_med_manejo_aptitud', inputValue: 'APTO', checked: true},
                {boxLabel: 'APTO CON OBSERVACION', name: 'm_med_manejo_aptitud', inputValue: 'APTO CON OBSERVACION'},
                {boxLabel: 'NO APTO', name: 'm_med_manejo_aptitud', inputValue: 'NO APTO'}
            ]
        });

        this.tbar4 = new Ext.Toolbar({
            items: ['->', '<b style="color:#000000;">RECOMENDACIONES Y CONCLUSIONES</b>',
                '-', {
                    text: 'Nuevo',
                    iconCls: 'nuevo',
                    handler: function () {
...
//                                            labelWidth: 60,
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.medicina_manejo.win.el.mask('Guardando…', 'x-mask-loading');
                        this.frm.getForm().submit({params: {
                                acction: (this.record.get('st') >= 1) ? 'update_medicina_manejo' : 'save_medicina_manejo'
                                , id: this.record.get('id')
                                , adm: this.record.get('adm')
                                , ex_id: this.record.get('ex_id')
                            },
    ...
    crea_controles: function () {
        ...
        this.frm = new Ext.FormPanel({
            ...
            buttons: [{
                    ...
                    scope: this,
                    handler: function () {
                        mod.medicina.manejo_conclu.win.el.mask('Guardando…', 'x-mask-loading');
                        var metodo;
                        var conclu_conduc_med_id;
                        if (this.record2 !== null) {
                            metodo = 'update';
                            conclu_conduc_med_id = mod.medicina.manejo_conclu.record2.get('conclu_conduc_med_id');
                        } else {
                            metodo = 'save';
                        ...
                        this.frm.getForm().submit({params: {
                                ...
                                , conclu_conduc_med_adm: mod.medicina.medicina_manejo.record.get('adm')

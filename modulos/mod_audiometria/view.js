        ...
        this.dt_grid = new Ext.grid.GridPanel({
            ...
            listeners: {
                rowclick: function (grid, rowIndex, e) {
                    e.stopEvent();
                    var record = grid.getStore().getAt(rowIndex);//
                    if (record.get('ex_id') == 2) {//examen psicologia
...
//                    mod.audio.audio_pred.init(record);//
                ...
                rowcontextmenu: function (grid, index, event) {
                    ...
                    if (record.get('st') == "1") {
                        if (record.get('ex_id') == 2) {   //PSICOLOGIA - LAS BAMBAS
                            new Ext.menu.Menu({
                                items: [{
                                        text: 'FORMATO AUDIOMETRIA N°: <B>' + record.get('adm') + '<B>',
                                        iconCls: 'reporte',
                                        handler: function () {
                                            if (record.get('st') >= 1) {
                                                new Ext.Window({
                                                    ...
                                                    closeAction: 'close',
                                                    resizable: true,
                                                    html: "<iframe width='100%' height='100%' src='system/loader.php?sys_acction=sys_loadreport&sys_modname=mod_audiometria&sys_report=formato_audiometria&adm=" + record.get('adm') + "'></iframe>"
                                                }).show();
                                            } else {
            ...
            buttons: [{
                    ...
                    handler: function () {
                        ...
                        this.frm.getForm().submit({
                            params: {
                                acction: (this.record.get('st') >= 1) ? 'update_audio_pred' : 'save_audio_pred'
...
//m_a_audio_ruido_laboral
        this.m_a_audio_ruido_laboral = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'Ruido no Molesto', name: 'm_a_audio_ruido_laboral', inputValue: 'Ruido no Molesto'},
                {boxLabel: 'Ruido Moderado', name: 'm_a_audio_ruido_laboral', inputValue: 'Ruido Moderado', checked: true},
                {boxLabel: 'Ruido Muy Intenso', name: 'm_a_audio_ruido_laboral', inputValue: 'Ruido Muy Intenso'}
            ]
        });
//m_a_audio_antece_familiar
        this.m_a_audio_antece_familiar = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_familiar', inputValue: 'NO', checked: true}
            ]
        });
...
//m_a_audio_antece_01
        this.m_a_audio_antece_01 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_01', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_02
        this.m_a_audio_antece_02 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_02', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_03
        this.m_a_audio_antece_03 = new Ext.form.RadioGroup({
            fieldLabel: '<b>HOBBIES CON EXPOSICIÓN A RUIDO: TIRO, DISCOTECAS, AUDIFONOS</b>',
            items: [
                {boxLabel: 'SI', name: 'm_a_audio_antece_03', inputValue: 'SI'},
                {boxLabel: 'NO', name: 'm_a_audio_antece_03', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_04
        this.m_a_audio_antece_04 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_04', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_05
        this.m_a_audio_antece_05 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_05', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_06
        this.m_a_audio_antece_06 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_06', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_07
        this.m_a_audio_antece_07 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_07', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_08
        this.m_a_audio_antece_08 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_08', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_09
        this.m_a_audio_antece_09 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_09', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_antece_10
        this.m_a_audio_antece_10 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_antece_10', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_sintoma_01
        this.m_a_audio_sintoma_01 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_sintoma_01', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_sintoma_02
        this.m_a_audio_sintoma_02 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_sintoma_02', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_sintoma_03
        this.m_a_audio_sintoma_03 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_sintoma_03', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_sintoma_04
        this.m_a_audio_sintoma_04 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_sintoma_04', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_sintoma_05
        this.m_a_audio_sintoma_05 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_sintoma_05', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_sintoma_06
        this.m_a_audio_sintoma_06 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_sintoma_06', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_sintoma_07
        this.m_a_audio_sintoma_07 = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_sintoma_07', inputValue: 'NO', checked: true}
            ]
        });
...
//m_a_audio_tapones
        this.m_a_audio_tapones = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'OCASIONAL', name: 'm_a_audio_tapones', inputValue: 'OCASIONAL'},
                {boxLabel: 'SIEMPRE', name: 'm_a_audio_tapones', inputValue: 'SIEMPRE'}
            ]
        });
//m_a_audio_orejeras
        this.m_a_audio_orejeras = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'OCASIONAL', name: 'm_a_audio_orejeras', inputValue: 'OCASIONAL'},
                {boxLabel: 'SIEMPRE', name: 'm_a_audio_orejeras', inputValue: 'SIEMPRE'}
            ]
        });
//m_a_audio_nariz
        this.m_a_audio_nariz = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'NORMAL', name: 'm_a_audio_nariz', inputValue: 'NORMAL', checked: true},
...
//m_a_audio_orofaringe
        this.m_a_audio_orofaringe = new Ext.form.RadioGroup({
            ...
            items: [
                {boxLabel: 'NORMAL', name: 'm_a_audio_orofaringe', inputValue: 'NORMAL', checked: true},
                {boxLabel: 'ANORMAL', name: 'm_a_audio_orofaringe', inputValue: 'ANORMAL'}
            ]
        });
...
//m_a_audio_oido
        this.m_a_audio_oido = new Ext.form.RadioGroup({
            fieldLabel: '<b>OIDO</b>',
            items: [
                {boxLabel: 'NORMAL', name: 'm_a_audio_oido', inputValue: 'NORMAL', checked: true},
...
//m_a_audio_otros
        this.m_a_audio_otros = new Ext.form.RadioGroup({
            fieldLabel: '<b>OIDO</b>',
            items: [
                {boxLabel: 'NORMAL', name: 'm_a_audio_otros', inputValue: 'NORMAL', checked: true},
...
//m_a_audio_otos_abomba_od
        this.m_a_audio_otos_abomba_od = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_otos_abomba_od', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_otos_serumen_od
        this.m_a_audio_otos_serumen_od = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_otos_serumen_od', inputValue: 'NO', checked: true}
            ]
        });
...
//m_a_audio_otos_abomba_oi
        this.m_a_audio_otos_abomba_oi = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_otos_abomba_oi', inputValue: 'NO', checked: true}
            ]
        });
//m_a_audio_otos_serumen_oi
        this.m_a_audio_otos_serumen_oi = new Ext.form.RadioGroup({
            ...
            items: [
                ...
                {boxLabel: 'NO', name: 'm_a_audio_otos_serumen_oi', inputValue: 'NO', checked: true}
            ]
        });
...
//                                            labelAlign: 'top',
                            ...
                            items: [{
                                    xtype: 'fieldset',
                                    layout: 'column',
                                    title: 'ALGUN FAMILIAR(PADRES, HERMANOS, TIOS O ABUELOS) QUE SUFRAN O HAYAN SUFRIDO DE SORDERA',
                                    items: [{
                                            columnWidth: .40,
                                            border: false,
                                            layout: 'form',
...
//                                            labelAlign: 'top',
                ...
                , {
                    title: '<b>--->  AUDIOMETRIA - DIAGNOSTICOS</b>',
                    iconCls: 'demo2',
                    layout: 'column',
                    autoScroll: true,
                    border: false,
            ...
            buttons: [{
                    ...
                    handler: function () {
                        ...
                        this.frm.getForm().submit({params: {
                                acction: (this.record.get('st') >= 1) ? 'update_audio_audio' : 'save_audio_audio'
                                , id: this.record.get('id')
                                , adm: this.record.get('adm')
                                , ex_id: this.record.get('ex_id')
                            },

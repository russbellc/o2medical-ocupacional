...
$pdf->SetFont('helvetica', '', $texto);
$pdf->MultiCell(180, $h * 2, $psico_examen->data[0]->m_psico_exam_area_cognitiva, 1, 'L', 0, 1);
$pdf->SetFont('helvetica', 'B', $titulo);
$pdf->Cell(90, $h, ' - AREA EMOCIONAL:', 1, 1, 'L', 1);
$pdf->SetFont('helvetica', '', $texto);
$pdf->MultiCell(180, $h * 2, $psico_examen->data[0]->m_psico_exam_area_emocional, 1, 'L', 0, 1);

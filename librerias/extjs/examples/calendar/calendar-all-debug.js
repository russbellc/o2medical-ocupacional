        ...
        if (t) {
            if (t.id && t.id.indexOf(this.dayElIdDelimiter) > -1) {
                ...
                if (!rel || dt != relDate) {
                    ...
                    this.fireEvent('Dia' + type, this, Date.parseDate(dt, "Ymd"), el);
                }
            }
        }
    },
...
Ext.calendar.MonthView = Ext.extend(Ext.calendar.CalendarView, {
     ...
     * The text to display in the current day's box in the calendar when {@link #showTodayText} is true (defaults to 'Hoy')
     */
    todayText: 'Hoy',
    /**
...
Ext.calendar.CalendarPanel = Ext.extend(Ext.Panel, {
    ...
    /**
     * @cfg {String} todayText
     * Alternate text to use for the 'Hoy' nav bar button.
     */
    todayText: 'Hoy',
    /**
     * @cfg {Boolean} showTodayText
    ...
    /**
     * @cfg {String} dayText
     * Alternate text to use for the 'Dia' nav bar button.
     */
    dayText: 'Dia',
    /**
     * @cfg {String} weekText
     * Alternate text to use for the 'Semana' nav bar button.
     */
    weekText: 'Semana',
    /**
     * @cfg {String} monthText
     * Alternate text to use for the 'Mes' nav bar button.
     */
    monthText: 'Mes',
